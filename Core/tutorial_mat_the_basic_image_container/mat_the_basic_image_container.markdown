...
The above objects, in the end, point to the same single data matrix. Their headers are
...
For debugging purposes it's convenient to see the actual values created in a matrix.
